...
### Milestone 3 — Incentive Mechanism
...
| -----: | ----------- | ------------- |
| **0a.** | License | Apache 2.0 |
| **0b.** | Documentation | We will provide documentation that describes how this mechanism functions, documentation for the code, and example snippets for using this mechanism. |
| **0c.** | Testing and Testing Guide | The core logic of the mechanism will be tested using unit tests. |
| **0d.** | Docker | A Dockerfile will be provided for building a node with the mechanism for testing purposes. |
| 1. | Mandatory-participation mechanism | Using this mechanism, blockchain networks wishing to utilize the BCDNS’ discovery services will be obliged to provide resources for the maintenance of both the root and their respective TLD networks. This will be implemented using a combination of off-chain workers and a runtime pallet to produce a crate that provides the functionality of the mechanism. |
...
| -----: | ----------- | ------------- |
| **0a.** | License | Apache 2.0 |
| **0b.** | Documentation | In addition to the scripts being documented, we will provide documentation for their usage. Our documentation will also include our evaluation results. |
| **0c.** | Testing and Testing Guide | The functionality of the scripts will be tested using unit tests. |
| **0d.** | Docker | This milestone does not require any Dockerfiles being delivered. |
